...
import stellarburgers.OrderClient;
import stellarburgers.User;
import stellarburgers.UserClient;
...
public class GetOrderTest {
    ...
    @Description("Успешное получение заказов авторизованного пользователя")
    ...
    @Description("Неуспешное получение заказов авторизованного пользователя")
